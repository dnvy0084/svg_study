...
var _BaseCase2 = __webpack_require__(58);
...
var CaseBarGraph = function (_BaseCase) {
	...
	(0, _createClass3.default)(CaseBarGraph, [{
		...
		value: function start() {
			...
			this.d3stage.selectAll('rect').data((0, _data.random)(5, 50, 500)).enter().append('rect').attr('x', this.margin).attr('y', function (d, i) {
				return _this2.margin + i * (_this2.graphHeight + _this2.gap);
...
var _CaseBarGraph = __webpack_require__(55);

var _CaseBarGraph2 = _interopRequireDefault(_CaseBarGraph);

var _async = __webpack_require__(56);
...
function appendAll(doms) {
	var div = document.body.getElementsByTagName('div')[0]; //document.getElementById( 'wrapper' );

	console.log(doms, div);
...
var BaseCase = function () {
	...
	(0, _createClass3.default)(BaseCase, [{
		...
		value: function _init(width, height) {
			...
			this.d3stage = d3.select(document.createElement('svg')).attr('width', width).attr('height', height);

			var d3wrapper = d3.select(this.wrapper); //.classed('case-container', true);

			[this.d3header, this.d3stage].forEach(function (d3dom) {
				return _this.wrapper.appendChild(d3dom.node());
			});
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function(test, buggy, set){
      try {
        set = __webpack_require__(12)(Function.call, __webpack_require__(26).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(54), __webpack_require__(113)))
